  ...
  <div class="header">
    ...
    <div class="header-left">
      ...
      <router-link to="#" class="logo2">
        <img src="~/assets/img/logo.jpg" width="40" height="40" alt="Logo">
      </router-link>
    </div>
    ...
    <a @click="toggleMobile()" id="mobile_btn" class="mobile_btn" href="#sidebar"><i
...
const toggleSidebar = () => {
  console.log('in')
  console.log(document.querySelectorAll(".body")[0].classList.contains("mini-sidebar"))
  // return
